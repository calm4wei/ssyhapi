...
<%
	...
	if(AlipayNotify.verify(params)){//验证成功
		if(trade_status.equals("TRADE_FINISHED") || trade_status.equals("TRADE_SUCCESS")){  //TRADE_FINISHED签约产品不支持退款或超出退款期限    TRADE_SUCCESS 签约产品支持退款          
			...
			OrderDAO.getInstance().updateOrderPayStatus(orderIds, trade_no);
